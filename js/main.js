...
(()=>{
    ...
    document.addEventListener("click",(event)=>{
        if(event.target.classList.contains("link-item")){
            // make sure that target.hash has a value before overriding default behaviour
            if(event.target.hash!==""){
                ...
                if(navMenu.classList.contains("open")){
                    // activate existing navigation menu link item
...
(()=>{
    ...
    tabsContainer.addEventListener("click",(event)=>{
        /* if event.target contains "tab-item" class and does not
...
(()=>{
    ...
    portfolioItemsContainer.addEventListener("click",(event)=>{
        if(event.target.closest(".portfolio-item-inner")){
            ...
            // get the index of portfolioItem
    ...
    function popupSlideshow(){
        ...
        // activate loader till popup image loads
        popup.querySelector(".pp-loader").classList.add(".active");
        popupImg.src=imgSrc
        popupImg.onload=()=>{
            // deactivate the loader after the image is loaded
...
(()=>{
    ...
    slides=silderContainer.querySelectorAll(".testi-item"),
    slideWidth=silderContainer.offsetWidth,
    prevBtn=document.querySelector(".testi-slider-nav .prev"),
    nextBtn=document.querySelector(".testi-slider-nav .next"),
    activeSlide=silderContainer.querySelector(".testi-item.active");
    ...
    silderContainer.style.width = slideWidth * slides.length + "px";
    ...
    function slider(){
        ...
        silderContainer.querySelector(".testi-item.active").classList.remove("active");
        // activate new slides
...
/*--------------- hiding all sections accept active -------------------------*/
(()=>{
